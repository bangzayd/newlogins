...
<body class="p-3 mb-2 bg-succes text-white">
  ...
  <div class="col-sm-5 col-sm-offset-2 col-md-8 col-md-offset-0">
    <table class="table table-bordered">
     <tr class="info">
      <th colspan="5" class="text-center">Edit Data Kendaraan</th>
    </tr>
    ...
    <tr> 
      ...
      include('koneksi.php');
      $id = $_GET['id'];
      $show = mysqli_query($koneksi, "SELECT * FROM b WHERE b0='$id'");
      ...
      <form action="edit-proses.php" method="post">
        ...
        <tr>
          ...
          <td><input type="text" name="_a" value="<?php echo $data['b1']; ?>" required></td>
        </tr>
      </tr>
      <tr>
       <td>&nbsp;</td>
